...
public class Hra {
    ...
    private static int pocetVyhernych;
    
    private ArrayList<Hrac> vyherci;
    private Hrac vyhercaKola;
    private Scanner input;
    private UloznePriestory uloznePriestory;
    ...
    public Hra(int velkost, int pocetPolicokZaSebou, int pocetHracov, int pocetVyhernych) { 
        ...
        this.uloznePriestory = new UloznePriestory();
    }
    
    /**
     * @return ArrayList<Hrac> vráti list hráčov
     */
    public static ArrayList<Hrac> getHraci() {
        return Hra.hraci;
    }
     ...
     */
    public static HraciaPlocha getHraciaPlocha() {
        return Hra.hraciaPlocha;
    }
    ...
    public static int getPocetHracov() {
        return Hra.pocetHracov;
    }
    
    /**
     * @return int vráti počet výherných kôl, ktoré sú potrebné pre výhru
     */
    public static int getPocetVyhernych() {
        return Hra.pocetVyhernych;
    }
    
    /**
     * Metóda slúži na nastavenie novej hracej plochy.
     * 
     * @param novaPlocha určuje novú hraciu plochu, ktorú chceme nastaviť
     */
    public static void setNovaHraciaPlocha(HraciaPlocha novaPlocha) {
        Hra.hraciaPlocha = novaPlocha;
    }
    
    /**
     * Metóda slúži na nastavenie nového počtu hráčov.
     * 
     * @param novyPocetHracov určuje počet nových hráčov
     */
    public static void setPocetHracov(int novyPocetHracov) {
        Hra.pocetHracov = novyPocetHracov;
    }
    
    /**
     * Metóda slúži na nastavenie počtu výherných kôl.
     * 
     * @param novyPocetVyhernych určuje novy počet výherných kôl, ktoré sú potrebné na výhru
     */
    public static void setPocetVyhernych(int novyPocetVyhernych) {
        Hra.pocetVyhernych = novyPocetVyhernych;
    }
    ...
    private void moznostiHry() throws IOException {
        ...
        switch (znak) {
            case 'c':
                ...
                break;
            case 's':
                if (!this.uloznePriestory.vyberSave(true)) {
    ...
    public void menuHry() throws IOException {
        ...
        switch (znak) {
            case 'n':
                ...
                break;
            case 'c':
                if (this.uloznePriestory.vyberSave(false)) {
